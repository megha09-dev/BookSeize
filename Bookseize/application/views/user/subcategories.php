        ...
        <div class="row">
          ...
          ?>
              ...
              <?php
                if($showmore==1) 
                { ?>
                  <center><a href="?id=<?php echo $_GET["id"] ?>&cid=<?php echo $_GET["cid"] ?>&showmore=<?php echo  count($book)+3 ?>" class="btn btn-secondary " id="showmore" style="padding-top:5px" ><h4>Show More</h4></a></center>
                <?php
                }
              ?>
