      ...
      <div class="container padding-bottom-3x mb-2">
        <div class="row justify-content-center">
          <div class="col-lg-8 col-md-10">
            ...
            <form class="card mt-4" method="post" action="<?php echo base_url();?>u_c/setpwd">
              <div class="card-body">
                <div class="form-group">
                  <label for="email-for-pass">Enter OTP</label>
                  <input class="form-control" type="text" name="txtotp" id="email-for-pass" required id="txtotp">
                </div>
              </div>
              <div class="card-footer">
                <input class="btn btn-primary" type="submit" name="btnfpwd" value="Submit">
              </div>
            </form>
          </div>
        </div>
...
<?php
  ...
  { ?>
    ...
    <script type="text/javascript">
      swal("Invalid!", "Invalid OTP", "error");
    </script>
