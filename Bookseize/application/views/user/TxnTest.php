...
<body style="text-align:center;" >
	...
	<form method="post" action="paytm/paytmpost">
	<center>
	<div class="card bg-secondary text-center mb-3 " style="margin-top: 100px;">
              <div class="card-header text-lg">Merchant Check Out Page</div>
              <div class="card-body">
			...
			<tbody>
				...
				<tr>
					...
					<td><input id="CUST_ID" tabindex="2" maxlength="12" size="12" name="CUST_ID" autocomplete="off" value="<?php echo $_SESSION['UserId']?>"></td>
				</tr>
				<tr>
					<td>3</td>
				...
				<tr>
					...
					<td><input title="TXN_AMOUNT" tabindex="10"
						...
						value="<?php echo $_SESSION['Price']?>" readonly>
					</td>
				</tr>
				<tr>
					<td></td>
