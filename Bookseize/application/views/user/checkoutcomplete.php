      ...
      <div class="container padding-bottom-3x mb-2">
        <div class="card text-center">
          <div class="card-body padding-top-2x">
            ...
            <p class="card-text">Make sure you make note of your order number, which is <span class="text-medium"><?php echo $_SESSION["OrderId"]?></span></p>
         
            </p>
            <div class="padding-top-1x padding-bottom-1x"><a class="btn btn-outline-secondary" href="<?php echo base_url() ?>user_c">Go Back Shopping</a><a class="btn btn-outline-primary" href="<?php echo base_url();?>u_c/myorders"><i class="icon-location"></i>&nbsp;Track order</a></div>
          </div>
        </div>
      </div>
